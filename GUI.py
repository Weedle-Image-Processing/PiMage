...
class Ui_PiMage(object):
    def setupUi(self, PiMage):
        ...
        self.applyButton.setGeometry(QtCore.QRect(50, 430, 101, 61))
        ...
        self.revertButton.setGeometry(QtCore.QRect(50, 360, 101, 61))
        ...
        self.histogramNormalButton.setGeometry(QtCore.QRect(10, 272, 181, 31))
        ...
        self.contrastEnhancementButton.setGeometry(QtCore.QRect(10, 312, 181, 31))
        ...
        self.filtersGroupBox.setGeometry(QtCore.QRect(10, 520, 951, 271))
        ...
        self.resizeGroupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.resizeGroupBox.setEnabled(True)
        self.resizeGroupBox.setGeometry(QtCore.QRect(280, 160, 321, 171))
        self.resizeGroupBox.setFocusPolicy(QtCore.Qt.NoFocus)
        self.resizeGroupBox.setAutoFillBackground(True)
        self.resizeGroupBox.setObjectName("resizeGroupBox")
        self.widthLineEdit = QtWidgets.QLineEdit(self.resizeGroupBox)
        self.widthLineEdit.setGeometry(QtCore.QRect(20, 50, 113, 31))
        self.widthLineEdit.setObjectName("widthLineEdit")
        self.heightLineEdit = QtWidgets.QLineEdit(self.resizeGroupBox)
        self.heightLineEdit.setGeometry(QtCore.QRect(190, 50, 113, 31))
        self.heightLineEdit.setObjectName("heightLineEdit")
        self.label = QtWidgets.QLabel(self.resizeGroupBox)
        self.label.setGeometry(QtCore.QRect(20, 30, 51, 16))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.resizeGroupBox)
        self.label_2.setGeometry(QtCore.QRect(190, 30, 51, 16))
        self.label_2.setObjectName("label_2")
        self.resizeOkButton = QtWidgets.QPushButton(self.resizeGroupBox)
        self.resizeOkButton.setGeometry(QtCore.QRect(60, 130, 75, 31))
        self.resizeOkButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.resizeOkButton.setObjectName("resizeOkButton")
        self.resizeCancelButton = QtWidgets.QPushButton(self.resizeGroupBox)
        self.resizeCancelButton.setGeometry(QtCore.QRect(190, 130, 75, 31))
        self.resizeCancelButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.resizeCancelButton.setObjectName("resizeCancelButton")
        self.resizeCheckBox = QtWidgets.QCheckBox(self.resizeGroupBox)
        self.resizeCheckBox.setGeometry(QtCore.QRect(110, 90, 121, 20))
        self.resizeCheckBox.setCursor(QtGui.QCursor(QtCore.Qt.WhatsThisCursor))
        self.resizeCheckBox.setWhatsThis("")
    ...
    def retranslateUi(self, PiMage):
        ...
        self.resizeGroupBox.setTitle(_translate("PiMage", "Resize"))
        self.label.setText(_translate("PiMage", "Width"))
        self.label_2.setText(_translate("PiMage", "Height"))
        self.resizeOkButton.setText(_translate("PiMage", "Ok"))
        self.resizeCancelButton.setText(_translate("PiMage", "Cancel"))
        self.resizeCheckBox.setToolTip(_translate("PiMage", "<html><head/><body><p>If you check this, resize will be calculated according to the value other than the box you left blank. If both boxes are full, it will be calculated based on width only.</p></body></html>"))
        self.resizeCheckBox.setText(_translate("PiMage", "Keep Aspect Ratio"))
